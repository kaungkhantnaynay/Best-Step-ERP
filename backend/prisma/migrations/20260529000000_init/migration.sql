...
-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('STOCK_IN', 'STOCK_OUT', 'RESERVE', 'RELEASE', 'TRANSFER', 'ADJUSTMENT', 'FULFILLMENT');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('DRAFT', 'CONFIRMED', 'RESERVED', 'FULFILLED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Inventory_productId_binId_key" ON "Inventory"("productId", "binId");
...
-- AddForeignKey
ALTER TABLE "Inventory" ADD CONSTRAINT "Inventory_binId_fkey" FOREIGN KEY ("binId") REFERENCES "WarehouseBin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
